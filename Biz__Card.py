# -*- coding: utf-8 -*-
"""
Created on Tue Dec  5 14:20:00 2023
...
icon = Image.open("C:/Users/ELCOT/GUVI/Python/DTM9/.spyder-py3/Biz_Card/icon.png")
...
if selected == "Home":
    ...
    with col2:
        st.image("C:/Users/ELCOT/GUVI/Python/DTM9/.spyder-py3/Biz_Card/icon.png")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join("C:/Users/ELCOT/GUVI/Python/DTM9/.spyder-py3/Biz_Card/uploaded_cards",uploaded_card.name), "wb") as f:
